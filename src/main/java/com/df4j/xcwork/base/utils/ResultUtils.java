...
import com.df4j.xcwork.base.res.AbstractResult;
...
public class ResultUtils {
    ...
    public static <T, N> AbstractResult<T, N> error(N errorNo, String errorMsg) {
        return newSingleResult(errorNo, errorMsg, null);
    }

    public static <T> AbstractResult<T, String> success() {
        return newSingleResult(SUCCESS_ERROR_CODE, SUCCESS_ERROR_MSG, null);
    }

    public static <T> AbstractResult<T, String> success(T result) {
    ...
    public static <T> AbstractResult<List<T>, String> success(List<T> result, int total, int pageNum, int pageSize) {
        return newPageResult(null, null, result, total, pageNum, pageSize);
    }


    public static <T, N> AbstractResult<T, N> newSingleResult(N errorCode, String errorMsg, T result) {
        return newSingleResult(SingleResult.class, errorCode, errorMsg, result);
    }

    public static <T, N> AbstractResult<List<T>, N> newMultipleResult(N errorCode, String errorMsg, List<T> result) {
        return newMultipleResult(MultipleResult.class, errorCode, errorMsg, result);
    }

    public static <T, N> AbstractResult<List<T>, N> newPageResult(N errorCode, String errorMsg, List<T> result,
                                                                  int total, int pageNum, int pageSize) {
        return newPageResult(errorCode, errorMsg, result, total, pageNum, pageSize);
    }

    public static <T, N> AbstractResult<T, N> newResult(Class<? extends AbstractResult> resultClass, N errorCode, String errorMsg, T result,
                                                        boolean multiple, boolean page, int total, int pageNum, int pageSize) {
        Assert.notNull(resultClass, "resultClass can not be null.");
        AbstractResult<T, N> resultObj = BeanUtils.instantiateClass(resultClass);
    ...
    public static <T, N> AbstractResult<T, N> newSingleResult(Class<? extends AbstractResult> resultClass,
                                                              N errorCode, String errorMsg, T result) {
        return newResult(resultClass, errorCode, errorMsg, result, false, false, 1, 1, 1);
    }

    public static <T, N> AbstractResult<List<T>, N> newMultipleResult(Class<? extends AbstractResult> resultClass,
    ...
    public static <T, N> AbstractResult<List<T>, N> newPageResult(Class<? extends AbstractResult> resultClass, N errorCode,
